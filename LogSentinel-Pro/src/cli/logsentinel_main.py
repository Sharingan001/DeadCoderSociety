#!/usr/bin/env python3
"""
LogSentinel Pro v3.0 - Main SIEM CLI
Log analysis, threat detection, and blockchain integrity.
"""
...
if PREMIUM_FEATURES:
    try:
        ...
        if RICH:
            ...
            console.print(f"[dim]✓ Premium engines loaded successfully ({reporter_type} PDF)[/dim]")
        ...
        try:
            if RICH:
                ...
                console.print(Panel(
                    ...
                    "[bold white]║[/bold white]                                                       [bold white]║[/bold white]\n"
                    "[bold white]╚═══════════════════════════════════════════════════════╝[/bold white]",
                    title="🛡️  LogSentinel Pro", border_style="cyan", box=DOUBLE
                ))
