#!/usr/bin/env python3
"""
LogSentinel Pro v4.0 - Admin CLI
...
║[/bold red] [bold white]🔐 LOGSENTINEL ADMIN[/bold white] [dim]v4.0.0[/dim]  [bold red]License Management Console[/bold red]     [bold red]║
╚═══════════════════════════════════════════════════════════════════╝[/bold red]"""
...
def cmd_version(args):
    ...
    if RICH:
        console.print(BANNER)
        console.print(Align.center("[bold white]v4.0.0[/bold white] • [dim]License Management Console[/dim]"))
